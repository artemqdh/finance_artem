...
using namespace creditcard;
using namespace debitcard;
...
int main()
{
    ...
    wallet::Wallet new_wallet("artemwallet", 5000, ListofCards);
    debitcard::DebitCard new_debit_card("debitcard1", 10000, 1252777, ListofCards);
    creditcard::CreditCard new_credit_card("creditcard1", 20000, "20.04.2027", ListofCards);
